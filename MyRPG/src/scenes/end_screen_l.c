                                            ...
                                            sfTexture *texture)
{
    ...
    scene->buttons[0]->name = button_text("START", 900, 320, 40);
    ...
    scene->buttons[1]->name = button_text("MENU", 900, 520, 40);
